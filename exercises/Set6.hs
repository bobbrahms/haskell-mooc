...
instance Eq a => Eq (List a) where
  --(==) x y = allTrue (map (\x -> (fst x == snd x)) (zip x y))
  (==) Empty Empty = True
  (==) (LNode a1 l1) (LNode a2 l2) = a1 == a2 && l1 == l2
  (==) _ _ = False
